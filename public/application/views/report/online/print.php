...
<html lang="en">
   <head>
      ...
      <title>Form Online Report</title>
      <!-- Datatable CSS -->
   ...
   <body>
      ...
      <div class="container">
         <div style="margin-top: 50px; margin-bottom: 25px">
            <h3 class="text-center suket" >Laporan Form Online</h3>
         </div>
   ...
   <script>
      $(document).ready(function(){
         ...
         let url1 = "<?= site_url('reportonline/get_ajax/a/b') ?>"

         console.log("tahub", tahun);
         console.log("buln", bulan);
         const newURL = url1.replace(url1.substr(44, 45), `/${bulan}/b`);
         // console.log(newURL.length)

         const newURL1 = newURL.length === 48 ?
            newURL.replace(newURL.substr(46, 47), `/${tahun}`)
